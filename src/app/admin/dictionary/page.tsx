...
const AUTO_DRAFT_SQL = sql<boolean>`coalesce((
  exists (
...
export default async function DictionaryPage() {
  ...
  const rows = await db
    .select({
      ...
      hasAutoGeneratedDraft: AUTO_DRAFT_SQL,
    })
    .from(sku_mappings)
    .leftJoin(
      finished_goods_catalog,
  ...
  const data: SkuMappingRow[] = rows.map(
    ({ mapping, catalog, bomCount, hasAutoGeneratedDraft }) => ({
